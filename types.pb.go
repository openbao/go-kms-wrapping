...
// RPCOptions holds options common to all wrappers that can pass over an
// RPC/plugin boundary.
...
func (x *RPCOptions) GetWithKeyId() string {
	if x != nil {
		return x.WithKeyId
	}
	return ""
...
func (x *RPCOptions) GetWithAad() []byte {
	if x != nil {
		return x.WithAad
	}
	return nil
...
func (x *RPCOptions) GetWithConfigMap() map[string]string {
	if x != nil {
...
func (x *RPCOptions) GetWithDisallowEnvVars() bool {
	if x != nil {
...
const file_types_proto_rawDesc = "" +
	...
	"\x0fwith_config_map\x18\x1e \x03(\v2'.wrapping.RPCOptions.WithConfigMapEntryR\rwithConfigMap\x123\n" +
...
var file_types_proto_goTypes = []any{
	...
	(*RPCOptions)(nil),    // 4: wrapping.RPCOptions
	nil,                   // 5: wrapping.WrapperConfig.MetadataEntry
	nil,                   // 6: wrapping.RPCOptions.WithConfigMapEntry
}
var file_types_proto_depIdxs = []int32{
	...
	6, // 2: wrapping.RPCOptions.with_config_map:type_name -> wrapping.RPCOptions.WithConfigMapEntry
