...
type KeyStore interface {
	...
	GenerateSecretKey(ctx context.Context, attrs *KeyAttributes) (Key, error)
	...
	GenerateKeyPair(ctx context.Context, attrs *KeyAttributes) (privKey Key, pubKey Key, err error)
