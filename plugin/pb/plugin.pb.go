...
type SetConfigRequest struct {
	...
	Options       *v2.RPCOptions         `protobuf:"bytes,20,opt,name=options,proto3" json:"options,omitempty"`
...
func (x *SetConfigRequest) GetOptions() *v2.RPCOptions {
	if x != nil {
		return x.Options
	}
	return nil
...
func (x *EncryptRequest) GetOptions() *v2.RPCOptions {
	if x != nil {
		return x.Options
	}
	return nil
...
func (x *DecryptRequest) GetOptions() *v2.RPCOptions {
	if x != nil {
		return x.Options
	}
	return nil
...
func (x *InitRequest) GetOptions() *v2.RPCOptions {
	if x != nil {
		return x.Options
	}
	return nil
...
func (x *FinalizeRequest) GetOptions() *v2.RPCOptions {
	if x != nil {
		return x.Options
	}
	return nil
...
const file_plugin_pb_plugin_proto_rawDesc = "" +
	"\n" +
	"\x16plugin/pb/plugin.proto\x12\x02pb\x1a\vtypes.proto\"B\n" +
	"\x10SetConfigRequest\x12.\n" +
	"\aoptions\x18\x14 \x01(\v2\x14.wrapping.RPCOptionsR\aoptions\"r\n" +
	...
	"\aoptions\x18\x14 \x01(\v2\x14.wrapping.RPCOptionsR\aoptions\"E\n" +
	...
	" \x01(\v2\x12.wrapping.BlobInfoR\n" +
	"ciphertext\x12.\n" +
	"\aoptions\x18\x14 \x01(\v2\x14.wrapping.RPCOptionsR\aoptions\"/\n" +
	...
	"\n" +
	"wrapper_id\x18\x01 \x01(\tR\twrapperId\x12.\n" +
	"\aoptions\x18\x14 \x01(\v2\x14.wrapping.RPCOptionsR\aoptions\"\x0e\n" +
	"\fInitResponse\"`\n" +
	"\x0fFinalizeRequest\x12\x1d\n" +
	"\n" +
	"wrapper_id\x18\x01 \x01(\tR\twrapperId\x12.\n" +
	"\aoptions\x18\x14 \x01(\v2\x14.wrapping.RPCOptionsR\aoptions\"\x12\n" +
...
var file_plugin_pb_plugin_proto_goTypes = []any{
	...
	(*v2.RPCOptions)(nil),     // 14: wrapping.RPCOptions
...
var file_plugin_pb_plugin_proto_depIdxs = []int32{
	14, // 0: pb.SetConfigRequest.options:type_name -> wrapping.RPCOptions
	15, // 1: pb.SetConfigResponse.wrapper_config:type_name -> wrapping.WrapperConfig
	14, // 2: pb.EncryptRequest.options:type_name -> wrapping.RPCOptions
	...
	14, // 5: pb.DecryptRequest.options:type_name -> wrapping.RPCOptions
	14, // 6: pb.InitRequest.options:type_name -> wrapping.RPCOptions
	14, // 7: pb.FinalizeRequest.options:type_name -> wrapping.RPCOptions
